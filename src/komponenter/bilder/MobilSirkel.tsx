...
const MobilSirkel: React.FC = () => {
    return (
        ...
        >
            <defs>
                <circle id="mobil_a" cx="40" cy="40" r="40" />
            </defs>
            <g fill="none" fillRule="evenodd">
                <circle
                    ...
                    fillRule="nonzero"
                />
                <mask id="mobil_b" fill="#fff">
                    <use xlinkHref="#a" />
                </mask>
                <g fillRule="nonzero" mask="url(#mobil_b)">
                    <path
                        fill="#59514B"
                    ...
                    <g transform="translate(28 17)">
                        <rect width="25" height="40" fill="#FFF" rx="1" />
                        <path fill="#6AB889" d="M1 1h23v13H1z" />
                        <path
                            fill="#B7B1A9"
                            d="M2 18h21v2H2zm0 5h21v2H2zm0 5h21v2H2z"
                        />
                    </g>
                    <path fill="#627282" d="M43 61a2 2 0 11-4 0 2 2 0 014 0" />
                    <path
                        fill="#E7E6E2"
                    ...
                    <path
                        fill="#BDD1D0"
                        d="M76.728 69L59 75.394 63.707 89H84z"
                    />
                    <path
                        fill="#6E9DAA"
